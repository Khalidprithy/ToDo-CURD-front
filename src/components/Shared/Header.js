...
const Header = () => {
    ...
    return (
        <div
            ...
            className="flex items-center justify-between bg-teal-500 dark:bg-teal-600 m-3 mx-auto w-11/12 md:w-8/12 ease-in-out duration-500 rounded-md text-white h-16">
